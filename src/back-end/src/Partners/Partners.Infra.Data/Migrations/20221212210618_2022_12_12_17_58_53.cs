    ...
    public partial class _20221212175853 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PartnersAggSettings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PartnersAggSettings_AspNetUsers_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PartnersAggSettings_UserId",
                table: "PartnersAggSettings",
                column: "UserId");
        }
