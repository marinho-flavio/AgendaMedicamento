...
namespace Companies.Adm.Panel.Server.Areas.Identity.Pages.Account
{
    public class ForgotPasswordModel : PageModel
    {
        ...
        public ForgotPasswordModel(UserManager<SES.Users.Identity.ApplicationUser> userManager, IEmailSender emailSender)
        {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToPage($"./VerificationCode", new { user.Email });
