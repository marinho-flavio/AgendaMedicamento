...
namespace Bravo.Companies.Infra.Data.Migrations
{
    ...
    [Migration("20221206015326_2022_12_5_22_31_52")]
    partial class _2022125223152
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bravo.Companies.Domain.Aggregates.ProfessionalsAgg.Entities.ProfessionalsAggSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("ProfessionalsAggSettings", t =>
                        {
                            t.ExcludeFromMigrations();
                        });
                });
            ...
            modelBuilder.Entity("Bravo.Companies.Domain.Aggregates.UsersAgg.Entities.User", b =>
                {
                    ...
                    b.HasOne("Bravo.Companies.Domain.Aggregates.ProfessionalsAgg.Entities.Funcionario", null)
                        .WithOne("User")
                        .HasForeignKey("Bravo.Companies.Domain.Aggregates.UsersAgg.Entities.User", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
