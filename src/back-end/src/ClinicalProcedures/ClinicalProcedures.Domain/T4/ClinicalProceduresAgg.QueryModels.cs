...
using MediatR;
namespace Bravo.ClinicalProcedures.Domain.Aggregates.UsersAgg.Queries.Models
{
...
namespace Bravo.ClinicalProcedures.Domain.Aggregates.ClinicalProceduresAgg.Queries.Models
{
	public partial class ClinicalProceduresAggSettingsQueryModel {
		public string Selector { get; set; }
		public string OrderBy { get; set; }
		public bool? OrderByDesc { get; set; }
		public bool? GetOnlySummary { get; set; }
